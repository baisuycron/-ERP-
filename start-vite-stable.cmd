...
if exist "%BUNDLED_NODE%" (
  "%BUNDLED_NODE%" "%VITE_ENTRY%" --host 127.0.0.1 --port 6173 --strictPort
) else if exist "%CODEX_NODE%" (
  "%CODEX_NODE%" "%VITE_ENTRY%" --host 127.0.0.1 --port 6173 --strictPort
) else (
  node "%VITE_ENTRY%" --host 127.0.0.1 --port 6173 --strictPort
)
pause
