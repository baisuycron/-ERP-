...
export const productsDb: ReceiptProduct[] = [
  ...
  { id: 'prod-007', barcode: '6901001001007', code: 'SKU1007', name: '黑椒牛肉粒 108g', spec: '108g/盒', unit: '盒', purchasePrice: 14.8, retailPrice: 22.9, deliveryPrice: 18.6, currentStock: 88, taxRate: 0.13, batchManaged: true },
  { id: 'prod-008', barcode: '6901001001008', code: 'SKU1008', name: '茉莉乌龙茶 500ml', spec: '500ml/瓶', unit: '瓶', purchasePrice: 4.6, retailPrice: 7.5, deliveryPrice: 5.8, currentStock: 360, taxRate: 0.13, batchManaged: true },
  { id: 'prod-009', barcode: '6901001001009', code: 'SKU1009', name: '抑菌洗手液 300ml', spec: '300ml/瓶', unit: '瓶', purchasePrice: 8.9, retailPrice: 15.9, deliveryPrice: 11.6, currentStock: 134, taxRate: 0.13, batchManaged: false },
  { id: 'prod-010', barcode: '6901001001010', code: 'SKU1010', name: '儿童酸奶 100g*8', spec: '8杯/组', unit: '组', purchasePrice: 18.6, retailPrice: 29.9, deliveryPrice: 23.8, currentStock: 72, taxRate: 0.09, batchManaged: true },
  { id: 'prod-011', barcode: '6901001001011', code: 'SKU1011', name: '厨房去油湿巾 80抽', spec: '80抽/包', unit: '包', purchasePrice: 6.5, retailPrice: 11.9, deliveryPrice: 8.6, currentStock: 192, taxRate: 0.13, batchManaged: false },
];
...
export let purchaseReceiptsDb: PurchaseReceipt[] = [
  ...
  buildReceipt({ id: 'receipt-004', status: 'saved', supplierId: 'sup-001', warehouseId: 'wh-001', purchaseOrderId: 'po-001', receiptDate: now.subtract(6, 'day').format('YYYY-MM-DD'), createdBy: '赵峰', attachments: [buildAttachment('送货单-坚果补货.pdf', '送货单')], items: [makeReceiptItem('prod-001', { orderQty: 24, actualQty: 24, batchNo: 'JG20260315B', productionDate: now.subtract(28, 'day').format('YYYY-MM-DD'), expiryDate: now.add(200, 'day').format('YYYY-MM-DD'), fromOrder: true, sourceOrderNo: 'CGDH20260320001' }), makeReceiptItem('prod-005', { orderQty: 30, actualQty: 30, batchNo: 'YB20260318F', productionDate: now.subtract(18, 'day').format('YYYY-MM-DD'), fromOrder: true, sourceOrderNo: 'CGDH20260320001' }), makeReceiptItem('prod-007', { actualQty: 12, batchNo: 'NR20260318A', productionDate: now.subtract(16, 'day').format('YYYY-MM-DD'), expiryDate: now.add(120, 'day').format('YYYY-MM-DD'), fromOrder: false })], remark: '补充到货，等待审核' }),
  buildReceipt({ id: 'receipt-005', status: 'saved', supplierId: 'sup-002', warehouseId: 'wh-002', purchaseOrderId: 'po-002', receiptDate: now.subtract(5, 'day').format('YYYY-MM-DD'), createdBy: '钱琳', attachments: [buildAttachment('签收单-冷链补货.jpg', '签收单')], items: [makeReceiptItem('prod-002', { orderQty: 120, actualQty: 118, giftQty: 2, batchNo: 'QP20260319A', productionDate: now.subtract(9, 'day').format('YYYY-MM-DD'), expiryDate: now.add(160, 'day').format('YYYY-MM-DD'), fromOrder: true, sourceOrderNo: 'CGDH20260321002', diffReason: '实收 118，赠送 2' }), makeReceiptItem('prod-004', { orderQty: 18, actualQty: 18, batchNo: 'NN20260320D', productionDate: now.subtract(12, 'day').format('YYYY-MM-DD'), expiryDate: now.add(35, 'day').format('YYYY-MM-DD'), fromOrder: true, sourceOrderNo: 'CGDH20260321002' }), makeReceiptItem('prod-010', { actualQty: 15, giftQty: 3, batchNo: 'SN20260320B', productionDate: now.subtract(8, 'day').format('YYYY-MM-DD'), expiryDate: now.add(22, 'day').format('YYYY-MM-DD'), fromOrder: false })], remark: '冷链商品先收货后复核' }),
  buildReceipt({ id: 'receipt-006', status: 'saved', supplierId: 'sup-003', warehouseId: 'wh-003', purchaseOrderId: 'po-003', receiptDate: now.subtract(4, 'day').format('YYYY-MM-DD'), createdBy: '王勇', attachments: [buildAttachment('送货单-日化批次.pdf', '送货单')], items: [makeReceiptItem('prod-003', { orderQty: 50, actualQty: 50, fromOrder: true, sourceOrderNo: 'CGDH20260322003' }), makeReceiptItem('prod-006', { orderQty: 25, actualQty: 24, giftQty: 1, fromOrder: true, sourceOrderNo: 'CGDH20260322003', diffReason: '赠送 1 提' }), makeReceiptItem('prod-009', { actualQty: 36, fromOrder: false })], remark: '门店日化到货待审核' }),
  buildReceipt({ id: 'receipt-007', status: 'saved', supplierId: 'sup-004', warehouseId: 'wh-002', receiptDate: now.subtract(3, 'day').format('YYYY-MM-DD'), createdBy: '陈凯', attachments: [buildAttachment('图片-试销乳品.png', '图片')], items: [makeReceiptItem('prod-004', { actualQty: 20, batchNo: 'NN20260322T', productionDate: now.subtract(7, 'day').format('YYYY-MM-DD'), expiryDate: now.add(28, 'day').format('YYYY-MM-DD'), fromOrder: false }), makeReceiptItem('prod-002', { actualQty: 60, giftQty: 0, batchNo: 'QP20260322X', productionDate: now.subtract(6, 'day').format('YYYY-MM-DD'), expiryDate: now.add(150, 'day').format('YYYY-MM-DD'), fromOrder: false })], remark: '无原单乳品试销入库' }),
  buildReceipt({ id: 'receipt-008', status: 'saved', supplierId: 'sup-001', warehouseId: 'wh-003', receiptDate: now.subtract(2, 'day').format('YYYY-MM-DD'), createdBy: '赵峰', attachments: [buildAttachment('送货单-跨仓补货.pdf', '送货单')], items: [makeReceiptItem('prod-001', { actualQty: 16, batchNo: 'JG20260323P', productionDate: now.subtract(14, 'day').format('YYYY-MM-DD'), expiryDate: now.add(210, 'day').format('YYYY-MM-DD'), fromOrder: false }), makeReceiptItem('prod-006', { actualQty: 18, giftQty: 2, fromOrder: false })], remark: '跨仓调配补货待审核' }),
  buildReceipt({ id: 'receipt-009', status: 'audited', supplierId: 'sup-001', warehouseId: 'wh-001', purchaseOrderId: 'po-001', receiptDate: now.subtract(5, 'day').format('YYYY-MM-DD'), createdBy: '赵峰', attachments: [buildAttachment('送货单-节前备货.pdf', '送货单')], items: [makeReceiptItem('prod-001', { orderQty: 36, actualQty: 36, batchNo: 'JG20260311Q', productionDate: now.subtract(32, 'day').format('YYYY-MM-DD'), expiryDate: now.add(190, 'day').format('YYYY-MM-DD'), fromOrder: true, sourceOrderNo: 'CGDH20260320001' }), makeReceiptItem('prod-005', { orderQty: 40, actualQty: 40, batchNo: 'YB20260312M', productionDate: now.subtract(20, 'day').format('YYYY-MM-DD'), fromOrder: true, sourceOrderNo: 'CGDH20260320001' }), makeReceiptItem('prod-007', { actualQty: 10, batchNo: 'NR20260321C', productionDate: now.subtract(17, 'day').format('YYYY-MM-DD'), expiryDate: now.add(118, 'day').format('YYYY-MM-DD'), fromOrder: false })], remark: '节前坚果入库已审核' }),
  buildReceipt({ id: 'receipt-010', status: 'audited', supplierId: 'sup-002', warehouseId: 'wh-002', purchaseOrderId: 'po-002', receiptDate: now.subtract(4, 'day').format('YYYY-MM-DD'), createdBy: '钱琳', attachments: [buildAttachment('质检单-冷链饮品.pdf', '质检单')], items: [makeReceiptItem('prod-002', { orderQty: 180, actualQty: 180, batchNo: 'QP20260313L', productionDate: now.subtract(11, 'day').format('YYYY-MM-DD'), expiryDate: now.add(155, 'day').format('YYYY-MM-DD'), fromOrder: true, sourceOrderNo: 'CGDH20260321002' }), makeReceiptItem('prod-004', { orderQty: 24, actualQty: 24, batchNo: 'NN20260314S', productionDate: now.subtract(16, 'day').format('YYYY-MM-DD'), expiryDate: now.add(32, 'day').format('YYYY-MM-DD'), fromOrder: true, sourceOrderNo: 'CGDH20260321002' }), makeReceiptItem('prod-008', { actualQty: 84, batchNo: 'WL20260322D', productionDate: now.subtract(7, 'day').format('YYYY-MM-DD'), expiryDate: now.add(145, 'day').format('YYYY-MM-DD'), fromOrder: false })], remark: '冷链饮品批次验收完成' }),
  buildReceipt({ id: 'receipt-011', status: 'audited', supplierId: 'sup-003', warehouseId: 'wh-003', purchaseOrderId: 'po-003', receiptDate: now.subtract(3, 'day').format('YYYY-MM-DD'), createdBy: '王勇', attachments: [buildAttachment('签收单-日化首批.jpg', '签收单')], items: [makeReceiptItem('prod-003', { orderQty: 30, actualQty: 30, fromOrder: true, sourceOrderNo: 'CGDH20260322003' }), makeReceiptItem('prod-006', { orderQty: 20, actualQty: 20, giftQty: 0, fromOrder: true, sourceOrderNo: 'CGDH20260322003' }), makeReceiptItem('prod-011', { actualQty: 42, fromOrder: false })], remark: '日化首批到货已完成审核' }),
  buildReceipt({ id: 'receipt-012', status: 'audited', supplierId: 'sup-004', warehouseId: 'wh-002', receiptDate: now.subtract(2, 'day').format('YYYY-MM-DD'), createdBy: '陈凯', attachments: [buildAttachment('送货单-乳品促销.pdf', '送货单')], items: [makeReceiptItem('prod-004', { actualQty: 28, batchNo: 'NN20260316U', productionDate: now.subtract(13, 'day').format('YYYY-MM-DD'), expiryDate: now.add(26, 'day').format('YYYY-MM-DD'), fromOrder: false }), makeReceiptItem('prod-002', { actualQty: 96, batchNo: 'QP20260316N', productionDate: now.subtract(12, 'day').format('YYYY-MM-DD'), expiryDate: now.add(148, 'day').format('YYYY-MM-DD'), fromOrder: false }), makeReceiptItem('prod-010', { actualQty: 22, batchNo: 'SN20260324E', productionDate: now.subtract(5, 'day').format('YYYY-MM-DD'), expiryDate: now.add(20, 'day').format('YYYY-MM-DD'), fromOrder: false })], remark: '乳品促销备货已审核' }),
  buildReceipt({ id: 'receipt-013', status: 'audited', supplierId: 'sup-001', warehouseId: 'wh-001', receiptDate: now.subtract(1, 'day').format('YYYY-MM-DD'), createdBy: '赵峰', attachments: [buildAttachment('签收单-零食加急.jpg', '签收单')], items: [makeReceiptItem('prod-001', { actualQty: 12, batchNo: 'JG20260317R', productionDate: now.subtract(22, 'day').format('YYYY-MM-DD'), expiryDate: now.add(205, 'day').format('YYYY-MM-DD'), fromOrder: false }), makeReceiptItem('prod-005', { actualQty: 55, batchNo: 'YB20260317H', productionDate: now.subtract(15, 'day').format('YYYY-MM-DD'), fromOrder: false }), makeReceiptItem('prod-008', { actualQty: 48, batchNo: 'WL20260325F', productionDate: now.subtract(4, 'day').format('YYYY-MM-DD'), expiryDate: now.add(142, 'day').format('YYYY-MM-DD'), fromOrder: false })], remark: '零食加急补货已审核' }),
];
